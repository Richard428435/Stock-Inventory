...
export default function InventoryLayout() {
  ...
  return (
    <>
      ...
      {startup && (
        <div className="fixed inset-0 z-[9999] bg-[#0a0a0a] flex flex-col items-center justify-center transition-opacity duration-1000 ease-in-out" style={{ opacity: startup ? 1 : 0 }}>
          <div className="relative">
            {/* Ambient Glow */}
            <div className="absolute inset-0 bg-[#c49a5b] blur-[100px] opacity-20 animate-pulse rounded-full"></div>
            {/* Logo Reveal */}
            <div className="flex flex-col items-center">
              <h1 className="text-4xl md:text-6xl font-serif text-white tracking-tighter relative z-10 animate-scale-in text-center" style={{ animationDuration: '2s' }}>
                CFFA Media <span className="text-[#c49a5b] italic">& Broadcasting</span>
              </h1>
              <h2 className="text-4xl md:text-6xl mt-4 relative z-10 animate-slide-up text-center drop-shadow-[0_10px_10px_rgba(196,154,91,0.4)]" style={{ 
                animationDelay: '500ms', 
                animationDuration: '1.5s', 
                fontFamily: '"Great Vibes", "Brush Script MT", cursive',
                background: 'linear-gradient(to bottom, #fde047 0%, #d97706 50%, #78350f 100%)',
          ...
          <div className="absolute bottom-20 flex flex-col items-center animate-slide-up delay-1000">
             <div className="w-48 h-1 bg-white/5 rounded-full overflow-hidden">
                <div className="h-full bg-gradient-to-r from-transparent via-[#c49a5b] to-transparent animate-progress" style={{ width: '100%' }}></div>
             </div>
             <p className="text-[10px] uppercase tracking-[0.4em] font-bold text-[#c49a5b] mt-4">Initializing Systems</p>
          </div>
        </div>
      )}
