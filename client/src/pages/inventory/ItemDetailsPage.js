  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        {/* Action Bar */}
        <div className="flex flex-wrap items-center gap-3 animate-slide-right delay-200">
          <button onClick={() => setShowDistribute(true)} className="px-6 py-3 rounded-2xl bg-gradient-to-r from-[#d1a66a] to-[#b78645] text-[#1a1a1a] font-bold uppercase tracking-widest hover:brightness-110 active:scale-95 transition-all text-xs border border-transparent shadow-[0_10px_20px_rgba(196,154,91,0.2)] hover-lux">
            Deploy
          </button>
          ...
          <div className="glass-liquid rounded-[2.5rem] p-8 border border-slate-200 dark:border-white/10 space-y-6 animate-slide-up delay-200 hover-lux">
            ...
            <div className="grid grid-cols-2 gap-6 mt-2">
              ...
              <div className="space-y-1">
                ...
                <span className="block text-lg text-slate-800 dark:text-white font-black">
                  {item.allocations?.length > 0 
                    ? item.allocations.map(a => `${a.location} (${a.quantity})`).join(' • ') 
